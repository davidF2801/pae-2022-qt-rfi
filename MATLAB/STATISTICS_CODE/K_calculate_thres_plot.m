...
% ku_mean, ku, sk_mean and sk are generated from "K_simulation_repetitions", being ku and sk 1000-posiitons-long vectors holding ku and sk from each repetition
...
saveas(fig1,strcat('K_ku_hist_thres.fig'));
saveas(fig1,strcat('K_ku_hist_thres.png'));
...
annotation('textbox',dim,'String',str,'FitBoxToText','on','EdgeColor','none');
saveas(fig2,strcat('K_sk_hist_thres.fig'));
saveas(fig2,strcat('K_sk_hist_thres.png'));
